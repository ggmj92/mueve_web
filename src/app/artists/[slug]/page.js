...
export default async function ArtistPage({ params }) {
    ...
    if (!artist) {
        return <main className={styles.container}><p>Artist not found</p></main>;
    }
        ...
        <main>
            ...
            <section className={styles.info}>
                <div className={styles.infoRow}>
                    ...
                    <a className={styles.portfolio} href="#" aria-label="Ver portafolio">Portafolio</a>
                </div>
                ...
                <section className={styles.cardsSection}>
                    <div className={styles.cards}>
                        {artist.artworks.map((aw) => {
                            ...
                            if (!url) return null;
                            return (
                                <a href={`/artists/${params.slug}/work/${aw._id}`} key={aw._id} className={styles.card}>
                                    <img src={url} alt={aw.title || "Artwork"} className={styles.cardImage} />
                                </a>
                            );
                        })}
                    </div>
